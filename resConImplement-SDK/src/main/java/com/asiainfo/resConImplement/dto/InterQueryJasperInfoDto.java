...
public class InterQueryJasperInfoDto implements Serializable {
    private Integer id;
	...
	public String toString() {
		return "InterQueryJasperInfoDto [id=" + id + ", serialnumber=" + serialnumber + ", queryaskinterface="
				+ queryaskinterface + ", queryjasperinterface=" + queryjasperinterface + ", queryservicename="
				+ queryservicename + ", iccid=" + iccid + ", inputparameter=" + inputparameter + ", returnparameter="
				+ returnparameter + ", returnstate=" + returnstate + ", returntime=" + returntime + ", reserve1="
