...
public class TcuChangeConfigDto implements Serializable {
    private Integer id;
	...
	public String toString() {
		return "TcuChangeConfigDto [id=" + id + ", carpricesname=" + carpricesname + ", carmodelsname=" + carmodelsname
				+ ", carname=" + carname + ", ifLive=" + ifLive + ", state=" + state + ", createtime=" + createtime
